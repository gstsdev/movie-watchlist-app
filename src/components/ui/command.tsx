...
>(({ className, ...props }, ref) => (
  <div className="flex items-center px-2.5 group" cmdk-input-wrapper="">
    <Search className="mr-2 h-3 w-3 shrink-0 opacity-50 group-focus-within:opacity-100" />
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "flex h-11 w-full rounded-md bg-transparent py-2 text-sm outline-none placeholder:text-zinc-500 focus:placeholder:text-black disabled:cursor-not-allowed disabled:opacity-50 dark:placeholder:text-zinc-400 dark:focus:placeholder:text-black",
        className
      )}
      {...props}
    />
